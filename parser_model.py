...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden=nn.Linear(n_features*self.embed_size,self.hidden_size)
    ...
    def embedding_lookup(self, t):
        ...
        x=x.view(x.shape()[0],self.n_features*self.embed_size)
        ### END YOUR CODE
        return x
    ...
    def forward(self, t):
        ...
        embeddings=self.embedding_lookup(self,t)
        hidden=self.embed_to_hidden(embeddings)
        hidden_units = nn.relu(hidden)
        dropout_lyer= self.dropout(hidden_units)
        logits=self.hidden_to_logits(dropout_lyer)
        ### END YOUR CODE
        return logits
